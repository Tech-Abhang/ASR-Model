...
```bash
python dataset_processor.py --dataset_path ./LibriSpeech/train-clean-100 --analyze
```

This creates:
- `output/dataset_manifest.json`: Sample dataset entries
- `output/dataset_stats.png`: Duration and speaker distribution charts
```
